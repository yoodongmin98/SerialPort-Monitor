...
void MyImGui::Instance()
{
	...
	::RegisterClassExW(&wc);
	hwnd = ::CreateWindowW(wc.lpszClassName, L"SerialPort Program", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX , 100, 100, 1500, 820, nullptr, nullptr, wc.hInstance, nullptr);
