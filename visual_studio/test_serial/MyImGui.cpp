...
void MyImGui::Instance()
{
	...
	::RegisterClassExW(&wc);
	HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"SerialPort Program", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX, 100, 100, 1800, 1050, nullptr, nullptr, wc.hInstance, nullptr);
